	...
	<form on:submit|preventDefault={handleSubmit} class="space-y-5">
		...
		<div>
			...
			{#if password && Object.keys(passwordErrors).length > 0}
				<ul class="mt-1 space-y-1 pl-4 text-xs text-red-600">
		...
		<div class="flex items-center">
			...
			<label for="agree-terms" class="ml-2 block text-sm text-gray-700">
				I agree to the <a href="/terms" class="text-[#1a5f4a] hover:underline">Terms of Service</a>
				and <a href="/privacy" class="text-[#1a5f4a] hover:underline">Privacy Policy</a>
			</label>
		</div>

		<Button type="submit" variant="primary" fullWidth={true} {loading}>Create account</Button>

		<div class="text-center">
			<p class="text-sm text-gray-600">
				Already have an account?
				<a href="/login" class="font-medium text-[#1a5f4a] hover:underline"> Sign in </a>
			</p>
		</div>
	</form>
</AuthLayout>
